...
public class BookModel
{
    ...
    [MaxLength(300)] public required string Author { get; set; }
    [MaxLength(100)] public required string Subject { get; set; }
    [MaxLength(100)] public required string Format { get; set; }
    [MaxLength(13)] public string Isbn13 { get; set; } = string.Empty;
    [MaxLength(10)] public string Isbn10 { get; set; } = string.Empty;
